...
export const applicationSchema = z.object({
  ...
  linkedin_founder: z.string().url().regex(linkedinRegex, "Debe ser LinkedIn").optional().or(z.literal("")),
  ...
  startup_linkedin: z.string().url().regex(linkedinRegex, "Debe ser LinkedIn").optional().or(z.literal("")),
  ...
  referral_1_linkedin: z.string().max(200).optional(),
  ...
  referral_2_linkedin: z.string().max(200).optional(),
  ...
  referral_3_linkedin: z.string().max(200).optional(),
