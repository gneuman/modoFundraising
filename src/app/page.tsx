...
const PLACEHOLDER_TESTIMONIOS: HomeTestimonio[] = [
  {
    ...
    ronda: "Seed US$1.2M",
    quote:
      "Modo Fundraising me dio la estructura que necesitaba para hablarle a los VCs con confianza. Cerré mi ronda en 4 meses.",
    foto_url: "",
    orden: 1,
    activa: true,
  },
  {
    ...
    quote:
      "El programa no es teoría. Es práctica pura. Cada misión la apliqué directo a mis conversaciones con inversores.",
    foto_url: "",
    orden: 2,
    activa: true,
  },
  {
    ...
    ronda: "Seed US$2M",
    quote:
      "Antes del programa tenía el pitch pero no el proceso. Ahora tengo los dos. La diferencia es brutal.",
    foto_url: "",
    orden: 3,
    activa: true,
  },
...
const PLACEHOLDER_CASOS: HomeCasoExito[] = [
  ...
  {
    startup_nombre: "LogiTech",
    logo_url: "",
    monto_usd: 1500000,
    investors: "Y Combinator · Softbank",
    hook: "Del MVP al preseed en 6 meses",
    orden: 5,
    activa: true,
  },
  {
    startup_nombre: "EduMax",
    logo_url: "",
    monto_usd: 500000,
...
export default async function HomePage() {
  ...
  const metricsData = [
    {
      ...
      value: metrics
        ? `+${formatUSD(metrics.capital_levantado_usd)}`
        : "+US$180M",
    },
    ...
    { label: "Países", value: metrics ? `${metrics.n_paises}` : "12" },
    {
      ...
      value: metrics ? `+${metrics.n_inversionistas}` : "+200",
    },
    {
      label: "Masterclasses",
  ...
  const jsonLd = {
    ...
    description:
      "Programa intensivo de 13 semanas para founders LatAm que quieren levantar su próxima ronda de inversión.",
    provider: {
      "@type": "Organization",
      name: "Impacta VC",
      url: "https://impacta.vc",
    },
      ...
      <div className="bg-(--brand-navy) text-white min-h-screen font-[var(--font-montserrat)">
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              {[
                ...
                {
                  value: metrics ? `+${metrics.n_startups}` : "+400",
                  label: "Startups",
                },
                {
                  value: metrics ? `${metrics.n_paises}` : "12",
                  label: "Países",
                },
                {
                  value: metrics ? `${metrics.nps}` : "9.2",
                  label: "NPS promedio",
                },
              ].map(({ value, label }) => (
                <div key={label}>
        ...
        <section className="bg-white/5 border-y border-white/10 py-20">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <p className="text-center text-white/50 mb-12 text-lg">
              Cuatro pilares que lo diferencian.
            </p>
          ...
          <div className="max-w-3xl mx-auto px-4">
            ...
            <div className="space-y-5 text-white/70 text-lg leading-relaxed">
              <p>
                ...
                <strong className="text-white">13 semanas, 100% online</strong>,
                diseñado para founders que están levantando una ronda entre
                US$500K y US$5M.
              </p>
              <p>
        ...
        <section className="bg-white/5 border-y border-white/10 py-20">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <p className="text-center text-white/50 mb-12">
              Startups que cerraron su ronda con el programa.
            </p>
        ...
        <section className="max-w-4xl mx-auto px-4 py-24">
          <div className="border border-(--brand-teal)/30 bg-(--brand-teal)/5 rounded-3xl p-10 text-center">
            ...
            <p className="text-white/80 text-lg mb-6 leading-relaxed">
              ...
              convence, te devolvemos el dinero.
            </p>
        ...
        <div className="border-y border-white/5 py-8 px-4">
          <div className="max-w-4xl mx-auto text-center text-white/30 text-xs leading-relaxed">
            Impacta VC y sus fondos afiliados se reservan el derecho de invertir
            hasta el 20% de la ronda de startups seleccionadas, sujeto a due
            diligence, fit de tesis y aprobación interna.
          </div>
        </div>
          ...
          <div className="mb-14">
            ...
            <div className="flex justify-center gap-8 flex-wrap">
              {tier2.length > 0 ? (
                ...
                <>
                  <div className="bg-white/10 border border-white/20 rounded-xl px-8 py-5 text-white font-bold text-lg">
                    Corfo
                  </div>
                  <div className="bg-white/10 border border-white/20 rounded-xl px-8 py-5 text-white font-bold text-lg">
                    Quintil Valley
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {tier3.length > 0
                ...
                : [
                    ...
                    <div
                      key={n}
                      className="bg-white/5 border border-white/10 rounded-lg px-5 py-3 text-white/40 text-sm"
                    >
                      {n}
                    </div>
                  ))}
