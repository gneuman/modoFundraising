              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {r.tipo && <div className="text-[#00e5c0] text-xs font-semibold">{r.tipo}</div>}
                  </div>
                </div>
                ...
                {r.linkedin_url && (
                  <a
                    ...
                    className="text-center text-xs font-bold border border-white/10 text-white/50 rounded-lg py-2 hover:border-[#00e5c0]/30 hover:text-[#00e5c0] transition-colors"
                  >
                    LinkedIn →
                  </a>
                )}
