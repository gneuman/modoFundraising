      ...
      <section className="max-w-3xl mx-auto px-4 py-20">
        ...
        <div className="space-y-10 text-white/70 leading-relaxed font-[var(--font-questrial)]">
          ...
          <div>
            ...
            <p className="mt-3">Para solicitar el reembolso, escribí a <a href="mailto:hello@impacta.vc" className="text-[#00e5c0] hover:underline">hello@impacta.vc</a> desde el correo registrado en el Programa.</p>
          </div>

          <div>
            <h2 className="text-white font-black text-xl mb-3">6. Cancelación</h2>
            <p>Podés cancelar tu participación en cualquier momento. La cancelación detiene futuros cobros pero no genera reembolso de los meses ya pagados (salvo dentro del período de garantía de 14 días del primer pago). Para cancelar, escribí a <a href="mailto:hello@impacta.vc" className="text-[#00e5c0] hover:underline">hello@impacta.vc</a>.</p>
          </div>
          ...
          <div>
            ...
            <p>El tratamiento de tus datos personales está regulado por nuestra <Link href="/privacidad" className="text-[#00e5c0] hover:underline">Política de Privacidad</Link>.</p>
          </div>
          ...
          <div>
            ...
            <p>Para consultas sobre estos términos: <a href="mailto:hello@impacta.vc" className="text-[#00e5c0] hover:underline">hello@impacta.vc</a> · Impacta VC SpA · Santiago, Chile.</p>
          </div>
