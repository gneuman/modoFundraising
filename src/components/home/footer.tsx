      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col gap-2 text-sm text-white/40">
            <span className="text-white/60 font-semibold text-xs uppercase tracking-widest mb-1">
              Legal
            </span>
            <Link
              href="/terminos"
          ...
          <div>
            <span className="text-white/60 font-semibold text-xs uppercase tracking-widest block mb-3">
              Newsletter
            </span>
            <div className="mb-5">
            ...
            <div className="flex gap-4 text-white/40 text-sm">
              <a
                href="https://linkedin.com/company/impactavc"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition-colors"
              >
              ...
              <a
                href="https://instagram.com/impactavc"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition-colors"
              >
              ...
              <a
                href="https://youtube.com/@impactavc"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition-colors"
              >
