...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-(--brand-whatsapp) hover:bg-(--brand-green) shadow-[0_4px_24px_#25D36660] transition-all hover:scale-110 active:scale-95"
    >
