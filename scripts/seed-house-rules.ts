...
const houseRules = [
  ...
  },
  {
    ...
    descripcion: "El valor del programa está en la interacción, no solo en el contenido. Las clases en vivo tienen preguntas, debates y feedback en tiempo real que no existe en la grabación. Comprométete a estar.",
    icon: "📡",
    obligatoria: false,
  },
  {
    nro: 4,
    categoria: "Asistencia",
    titulo: "Si no puedes asistir, avisa",
    descripcion: "La vida pasa. Si no puedes estar en una sesión, avisa con anticipación en el grupo. No es obligatorio, pero es respeto al equipo y a tus compañeros.",
    icon: "📢",
    obligatoria: false,
  },
  {
  ...
  },
  {
    ...
    descripcion: "Las sesiones Rockstar funcionan cuando todos comparten su avance. No tienes que tener todo perfecto — tienes que haber intentado. Compartir trabajo en progreso es parte del aprendizaje.",
    icon: "🚀",
    obligatoria: false,
  },
  {
    ...
    descripcion: "En las sesiones de revisión de pitch decks y estrategias, el feedback puede ser duro. Está orientado a hacerte mejor, no a bajarte el ánimo. Recíbelo y dalo desde ese lugar.",
    icon: "💬",
    obligatoria: false,
  },
  {
  ...
  },
  {
    ...
    descripcion: "Los VCs que participan como speakers o mentores lo hacen en un contexto específico. Contactarlos directamente sin una intro del equipo de Impacta VC puede quemar esa relación para todos. Siempre pide la intro primero.",
    icon: "⚠️",
    obligatoria: true,
  },
  {
